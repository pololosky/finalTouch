...
const CreateSignature = () => {
  ...
  const [activeContent2, setActiveContent2] = useState("droite");
  const handleButtonClick2 = (contentId: React.SetStateAction<string>) => {
    setActiveContent2(contentId);
  };
  ...
  return (
    <div className="">
      {/* les buttons */}
      <div className="xl:hidden lg:grid md:grid grid grid-cols-2 sticky rounded-t-xl top-0 z-1 p-2 w-full items-center gap-3 justify-center">
        <button
          className={`btn md:text-lg text-sm rounded-lg ${
            activeContent2 === "gauche" ? "btn-accent" : ""
          }`}
          onClick={() => handleButtonClick2("gauche")}
        >
          Edit Signature
        </button>
        <button
          className={`btn md:text-lg text-sm rounded-lg ${
            activeContent2 === "droite" ? "btn-accent" : ""
          }`}
          onClick={() => handleButtonClick2("droite")}
        >
          Preview
        </button>
      </div>

      {/* contenue pour petits ecrans*/}
      <div
        className={`xl:hidden lg:flex md:flex flex bg-base-200 md:p-2 p-1 xl:mt-0 lg:mt-0 md:mt-5 mt-5 rounded-xl`}
      >
        {/* la gauche */}
        {activeContent2 === "gauche" && (
          <div className="xl:w-2/5 lg:w-full md:w-full w-full px-2 pb-2 max-h-120 overflow-y-auto rounded-xl">
            {/* les boutons */}
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex justify-between items-center gap-3">
                      <ImputCase width="w-1/3">
                        <label
                          htmlFor="Name"
                          className="flex text-right w-full"
                        >
                          name
                        </label>
                        <input
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {templates.map((template) => (
                      <div className="w-full" key={template.id}>
                        ...
                        >
                          <div>
                            <div className="xl:flex lg:hidden md:hidden hidden w-full bg-red-500 h-full flex-col gap-4">
                            ...
                            <div className="skeleton xl:hidden lg:flex md:flex flex h-15 w-30"></div>
                          </div>
                        </button>
                      </div>
                    ))}
        ...
        {/* la droite */}
        {activeContent2 === "droite" && (
          <div className="flex-1 flex-col gap-20 justify-center items-center bg-base-200 rounded-xl">
            <div
              className=" justify-center bg-base-100 w-full shadow-md rounded-xl"
              id="signature-preview"
            >
              <selectTemplate.Component post={templateData} />
            </div>
            <div className="grid mt-5 grid-cols-2 h-full gap-2">
              <button
                onClick={exportAsPng}
                className="btn bg-white rounded-lg  text-sm"
              >
                Generate image
              </button>
              <button
          ...
          // <div className="droite xl:w-3/5 lg:w-full md:w-full w-full px-2 pb-2 max-h-148 bg-accent  overflow-y-auto rounded-xl">
          //   <div className="content-container">
          //       <div className="content-1 flex h-120 flex-col px-1 gap-5">
          //         <h1 className="flex w-full justify-center xl:text-2xl lg:text-2xl md:text-2xl text-lg mt-3">
          //           fill in your details
          //         </h1>
          ...
          //           <button
          //             onClick={exportAsPng}
          //             className="btn rounded-lg  xl:text-xl lg:text-xl md:text-lg text-sm"
          //           >
          //             Generate image
          //           </button>
          //           <button className="btn rounded-lg  xl:text-xl lg:text-xl md:text-lg text-sm">
          //             Copy the code
          //           </button>
          //           <button className="btn rounded-lg  xl:text-xl lg:text-xl md:text-lg text-sm">
          //             Copy signature
      ...
      {/* contenue pour grands ecrans */}
      <div className="xl:flex lg:hidden md:hidden hidden gap-3 bg-base-200 md:p-2 p-1 xl:mt-0 lg:mt-0 md:mt-5 mt-8 rounded-xl">
        {/* la gauche */}
        <div className="xl:w-2/5 lg:w-full md:w-full w-full px-2 pb-2 xl:max-h-148 lg:max-h-148 md:max-h-200 sm:max-h-240 max-h-140 overflow-y-auto rounded-xl">
          {/* les boutons */}
          <div className="button-group grid grid-cols-3 sticky rounded-t-xl top-0 z-1 p-2 bg-base-300 w-full items-center gap-1 justify-center">
            <button
              className={`btn md:text-lg text-sm rounded-lg ${
                ...
                <div className="grid grid-cols-2 gap-2">
                  {templates.map((template) => (
                    <div className="w-full" key={template.id}>
                      ...
                      >
                        <div className="xl:flex lg:flex md:flex hidden w-full bg-red-500 h-full flex-col gap-4">
                          <div className="flex items-center gap-4">
                            <div className="skeleton h-16 w-16 shrink-0 rounded-full"></div>
                            <div className="flex flex-col gap-4">
                              <div className="skeleton h-4 w-20"></div>
        ...
        {/* la droite */}
        <div className="xl:w-3/5 lg:w-full md:w-full w-full xl:block lg:hidden md:hidden sm:hidden hidden px-2 pb-2 h-148 bg-accent overflow-y-auto rounded-xl">
          <div className="content-container">
            <div className="content-1 flex h-120 flex-col px-1 gap-5">
              <h1 className="flex w-full justify-center md:text-2xl text-xl mt-3">
                fill in your details
              </h1>
              <div className="flex-1 flex justify-center items-center bg-base-200 py-5 rounded-xl">
                <div
                  className="bg-base-100 w-18/20 shadow-md rounded-xl"
                  id="signature-preview"
                >
                  <selectTemplate.Component post={templateData} />
                </div>
