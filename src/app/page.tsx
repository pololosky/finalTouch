...
export default function Home() {
  return (
    <Wrapper>
      <div className="md:px-15 px-5 mt-20 lg:mt-20 sm:mt-20">
        <div className="flex justify-between">
          ...
          <div className="xl:w-1/2 lg:w-full md:w-full w-full flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-5 md:z-20">
              <h1 className="up xl:text-6xl lg:text-6xl md:text-4xl text-4xl xl:text-left lg:text-center md:text-center sm:text-center text-center md:block">
                generate professional <span className="text-accent">Gmail</span>{" "}
                and <span className="text-accent">outlook</span> signatures
              </h1>
              <p className="up xl:text-xl lg:text-xl md:text-lg text-lg">
